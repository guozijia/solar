      ...
      <el-col :span="24">
        <div class="contop">
          <el-radio-group v-model="radio1" size="small">
            <el-radio-button label="1"><svg-icon icon-class="list" /></el-radio-button>
            <el-radio-button label="2"><svg-icon icon-class="statistics" /></el-radio-button>
          </el-radio-group>
        ...
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column label="电站ID" prop="id" align="center" width="80">
          ...
          <el-table-column label="电站类型" width="110px" align="center">
            <template slot-scope="{row}">
              <span>{{ row.name }}</span>
            </template>
          </el-table-column>
          <el-table-column label="装机容量" align="center">
            <template slot-scope="{row}">
          ...
          <el-table-column label="收益" class-name="status-col">
            <template slot-scope="{row}">
...
import { stationform } from '@/api/operation'
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      stationform(this.listQuery).then(res => {
