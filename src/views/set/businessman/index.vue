    ...
    <div class="dashboard-editor-flex">
      <div class="flex-title">
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect">
          <el-menu-item index="1">分销商</el-menu-item>
          <el-menu-item index="2">安装商</el-menu-item>
        </el-menu>
      </div>
    </div>
...
export default {
  ...
  components: { Distributor, Installers },
  data() {
    return {
      formInline: {
        search: '',
  ...
  methods: {
    handleSelect(key, keyPath) {
      if (key === '1') {
        this.FormType = 'Distributor'
      } else {
        this.FormType = 'Installers'
      }
    }
  }
}
