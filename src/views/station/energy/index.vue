    ...
    <el-row :gutter="16" style="margin-bottom:16px;">
      <el-col :span="6">
        <div class="card card-animate">
          <div class="card-body">
            <h5 class="text-muted text-uppercase mt-0">今日光伏发电</h5>
            <div class="avatar-sm ">
              <span class="avatar-title bg-soft-pv rounded-circle">
                <svg-icon icon-class="pv" />
              </span>
            </div>
      ...
      <el-col :span="6">
        <div class="card card-animate">
          <div class="card-body">
            <h5 class="text-muted text-uppercase mt-0">电池今日充电</h5>
            <div class="avatar-sm ">
            ...
            <el-divider />
            <div class="card-bot">
              <span class="text-muted text-bot">累计充电量：666kwh</span>
            </div>
          </div>
        </div>
      </el-col>
      <el-col :span="6">
        <div class="card card-animate">
          <div class="card-body">
            <h5 class="text-muted text-uppercase mt-0">电池今日放电</h5>
            <div class="avatar-sm ">
              <span class="avatar-title bg-soft-money rounded-circle">
                <svg-icon icon-class="batsub" />
              </span>
            </div>
            <h2 class="my-3 float-right">
            ...
            <el-divider />
            <div class="card-bot">
              <span class="text-muted text-bot">累计放电量：12520kwh</span>
            </div>
          </div>
        </div>
      </el-col>
...
export default {
  ...
  components: { CountTo, Chart, ChartMix, DeviceList, Environment, BatteryPower, BatterySoc },
  data() {
    return {
      items: [{
        id: 1,
